...
exports.insertForexData = {
  name: 'insertForexData',
  description: 'Insert data from YahooAPI into database',

  outputExample:{'Status': 'Success'},
        ...
        https.get(url, function(res) {
            ...
            res.on('end', function() {
              ...
              for(var i = 0; i < jsonObj.length; i++) {
                ...
                connection.response.results = 'Success';  
